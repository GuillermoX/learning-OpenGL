...
//--- TEXTURAS ----
    ...
    */
    unsigned char *data = stbi_load("../assets/textures/creeper.jpg", &width, &height, &nrChannels, 0);
    if(data)
    {
    ...
    if(data)
    {
        ...
        */
        ...
        glPixelStorei(GL_UNPACK_ALIGNMENT, 1);  //Desactivar alineación a 4 bytes
...
//---- BUCLE DE EJECUCIÓN ----
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        //Material uniforms
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "material.ambient"), 0.0f, 0.5098f, 0.5098f);
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "material.diffuse"), 0.0f, 0.5098f, 0.5098f);
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "material.specular"), 0.5019f, 0.5019f, 0.5019f);
        ...
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "light.ambient"),
                    ambientColor.x, ambientColor.y, ambientColor.z);
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "light.diffuse"),
        ...
        glUniform3f(glGetUniformLocation(shaderProgram.ID, "light.position"),
